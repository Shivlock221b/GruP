...
class Blocked extends StatefulWidget {
  const Blocked({Key key, this.friends, this.userName, this.socket}) : super(key: key);
...
class _BlockedState extends State<Blocked> {
  ...
  Future<List<dynamic>> getFriends() async {
    Response response = await http.get("api/getBlocked");
    List<dynamic> friends = json.decode(response.body)['blocked'];
    return friends;
  }
